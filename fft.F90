 ...
 100	  do i = 1,n2
	    ...
	    k1 = k+1
	    k1n2 = k1+n2
	    tr = fr(k1n2)*c+fi(k1n2)*s
	    ti = fi(k1n2)*c-fr(k1n2)*s
	    fr(k1n2) = fr(k1)-tr
	    fi(k1n2) = fi(k1)-ti
	    fr(k1) = fr(k1)+tr
	    fi(k1) = fi(k1)+ti
	...
	return
      ...
      subroutine tdfft(fr,fi,nux,nuy)
	...
	return
      ...
      subroutine tdifft(fr,fi,nux,nuy)
	...
	return
      ...
      subroutine tdrfft(fr,fi,nux,nuy)
